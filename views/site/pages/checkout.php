            ...
            <div class="row">
               <div class="col-12">
                  <div class="ribonbar d-flex items-center justify-center flex-wrap">
                     ...
                     <a href="<?= url('checkout') ?>" class="ribon-link active">Checkout</a>
                     <span class="d-block">
                        <i class="bx bx-chevron-right"></i>
                     </span>
            ...
            <div class="row">
               <div class="col-lg-7">
                  <span class="flex items-center flex-wrap text-black pb-4" style="border-bottom: 1px solid rgba(0, 0, 0, 0.1)">
                     ESTAS DE VOLTA ?
                     <a href="" name="openauth1290ub1390" class="text-muted block ml-0 sm:ml-2">FACA LOGIN NA SUA CONTA</a>
                  </span>
                  ...
                  <form action="#" method="POST" class="row">
                     ...
                     <div class="col-12">
                        <span class="mt-3 mb-0 block text-bold">Informar uma zona diferente</span>
               ...
               <div class="col-lg-5 mt-4 mt-lg-0">
                  <div class="cart-payment-details">
                     ...
                     <div class="payment-products-list">
                        ...
                        <a href="" id="showMoreContain" class="pp-list-show-more flex justify-center items-center w-50 w-lg-25 ml-auto mb-2">
                     ...
                     <div class="shipping py-3">
                        ...
                        <div class="shipping-list my-1 px-2">
                           ...
                           <label for="agreed-terms" class="flex ai-start">
                              ...
                              <small>Li e concordo com os <a href="" class="text-bold text-underline tetx-muted">os termos de uso</a> e <a href="" class="text-bold text-underline tetx-muted">as politicas de privacidade</a> da loja.</small>
                           </label>
                        </div>
                     </div>
