                     ...
                     <div class="list-card-item">
                        <div class="list-card-img">
                           ...
                           <div class="list-card-actions">
                              ...
                              <a href="" class="link" name="addTocart" data-target="item-<?= $a ?>">
                                 <i class="bx bx-cart"></i>
                              </a>
                           </div>
                        </div>
                        <span class="list-card-title">Vestido Frangose</span>
                        <small class="text-muted block list-card-category">Reservado para Galas</small>
                        <div class="list-ratings">
                           <?php for ($i = 0; $i < 5; $i++): ?>
                              <i class="bx bx-star"></i>
                           <?php endfor; ?>
                        </div>
                        <span class="list-card-price">10 000.00 AO</span>
                     </div>
                  <?php endfor ?>
               </div>
            </div>
                  ...
                  <?php for ($a = 0; $a < 3; $a++):  ?>
                     <div class="list-card-item" style="--list-card-width: 360px">
                        ...
                        <div class="list-contain text-left">
                           <span class="list-card-title">Vestido Frangose</span>
                           <small class="text-muted block mb-2 mt-2 list-card-category">Lorem ipsum dolor sit amet consectetur adipisicing elit. Similique, voluptatem voluptatibus laborum culpa et aliquid.</small>
